...
const Testimonial = ({ quote }: { quote: Quote }) => (
  <figure className="border-l-2 pl-5 md:pl-6 h-full" style={coralBorder}>
...
// All five client quotes, gathered for the testimonial carousel.
const testimonials: Quote[] = [
  ...
  },
  {
    text: (
      <>
        “She didn’t tell me what to do — she helped me discover how I wanted to show up. Widowed,
        I hadn’t dated in a very long time.{' '}
  ...
  },
  {
    text: (
      <>
        “I know I’m accomplished. But knowing how to make that interesting to someone else (on a
        date, no less) is not something I had really considered.{' '}
...
const offerings: Offering[] = [
  ...
  {
    tabLabel: 'Women who didn’t marry',
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 md:pt-28 pb-12">
        ...
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl leading-[1.04] mb-8">
          There&rsquo;s no clock to race. But there is a <em>window</em> to understand.
        </h1>
        <p className="text-lg md:text-xl leading-relaxed text-foreground/85 max-w-2xl mb-10">
          Your 40s, 50s, and 60s can be the best window to date — if you know it&rsquo;s not as
          simple as &ldquo;getting out there.&rdquo; No ticking clock, but there is a window.
          Understanding what to experience now is the game.
        </p>
      ...
      {/* ④ Why the usual advice fails you — teaser + accordion */}
          ...
          <AccordionItem value="harder">
            ...
            <AccordionContent>
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-foreground/80">
                <p>
                  There’s a trap no one warns you about: you’re successful — and that’s part of
                  what’s hiding the problem. You’re excellent in your field, so you assume you’ll
                  be fine here too. But being good at your job has almost nothing to do with this.
                  Most people just dive in — and learn the hard way.
                </p>
                <p>
                  You deserve strategies built for <em>this</em> moment in the timeline of dating.
                </p>
              </div>
            </AccordionContent>
          </AccordionItem>
            ...
            <AccordionContent>
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-foreground/80">
                <p>
                  ...
                  your well-meaning group chat.
                </p>
                <p>
                  I spent three years studying how Gen X actually dates, then built the playbook.
                  “Midlife” never fit; this generation needed its own approach. I was doing this
                  work before the apps existed, and I have a point of view, not a script.
                </p>
      ...
      >
        ...
        <Tabs defaultValue={offerings[0].title} className="w-full">
          <TabsList className="flex flex-wrap h-auto gap-1 mb-10">
            {offerings.map((o) => (
              <TabsTrigger key={o.title} value={o.title}>
                {o.tabLabel}
              </TabsTrigger>
            ))}
          </TabsList>
          ...
          {offerings.map((o) => (
            <TabsContent key={o.title} value={o.title} className="mt-0 focus-visible:outline-none">
              <div className="grid md:grid-cols-[220px_1fr] gap-8 items-start pt-2">
                {o.image && (
                  <div className="w-32 h-32 md:w-full md:h-auto md:aspect-square rounded-2xl overflow-hidden bg-muted">
                    <img
                      src={o.image}
                      alt={o.imageAlt ?? ''}
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg leading-relaxed text-foreground/85 mb-7">
                    {o.body}
                  </p>
