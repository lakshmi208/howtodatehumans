...
export const events: EventConcept[] = [
  ...
  },
  {
    ...
    description: 'Nobody loves their first responders more than Chicago. But connecting in the realm of dating can be challenging. This conversation and workshop will delve focus on how first responders can best tell their stories and the ins and outs of dating a person who answers the call.',
